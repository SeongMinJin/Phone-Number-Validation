			...
			<div className="flex flex-col justify-center items-center min-h-screen">
				...
				<div className="flex">
					<div className="relative">
						...
						<input onChange={(e) => setPhoneNumber(e.target.value)} onKeyDown={(e) => enter(e.key)} id="input" autoFocus type="tel" placeholder="01012345678" className=" rounded-sm shadow-sm pl-10 h-10 w-72 bg-gray-50 focus:outline-none  focus:ring-2 focus:ring-green-400 focus:border-green-400 duration-300" ></input>
					</div>
						<Link id="link" href={`/${icon}?number=${phoneNumber}`} className="ml-4 items-center flex justify-center">
						{ icon === 'report'
